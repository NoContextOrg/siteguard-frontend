    ...
    <div className="flex min-h-screen bg-slate-50 font-sans">
      ...
      <aside className="w-64 bg-[#1e293b] text-white flex flex-col fixed h-full z-20">
        ...
        <nav className="flex-1 px-4 space-y-2 mt-4">
          ...
          <button onClick={() => navigate('/admin_team')} className="flex items-center gap-4 w-full px-4 py-3 text-slate-400 hover:bg-slate-800 hover:text-white rounded-lg transition">
            ...
            <div className="bg-white p-6 rounded-xl border-l-8 border-l-orange-400 shadow-sm flex justify-between items-center">
                <div>
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        ...
                        <span className="text-4xl font-black text-orange-400">80%</span>
                    </div>
                </div>
                <div className="text-right">
                    <div className="bg-slate-100 px-2 py-1 rounded flex items-center gap-1 text-[12px] font-bold">
                        <ArrowUpRight size={12} className="text-green-500"/> 40.5%
                    </div>
                    <p className="text-[8px] font-bold text-slate-400 mt-1 uppercase">Vs Yesterday</p>
                </div>
            </div>
          </div>
